...
/**
 * A class that implements an undirected graph using an adjacency list as the
 * underlying data structure, and whose vertices hold elements of type E (which
 * should have a suitable hash function)
 *
 * @author Andrew Ensor
 */
import Chapter6.*;
