...
public class BinarySearchTreeSearch<E> extends AbstractSet<E>
    ...
    public BinarySearchTreeSearch(Collection<? extends E> c) {
        this();
        for (E element : c) {
            add(element);
        }
    ...
    public BinarySearchTreeSearch(Comparator<? super E> comparator) {
        this();
        this.comparator = comparator;
    }

    public BinarySearchTreeSearch(SortedSet<E> s) {
        this();
    ...
    private BinarySearchTreeSearch(BinaryTreeNode rootNode,
    ...
    public SortedSet<E> subSet(E fromElement, E toElement) {
        return new BinarySearchTreeSearch<>(rootNode, comparator, fromElement, toElement);
    }
    ...
    public BinaryTreeNode search(BinaryTreeNode searchNode) {
        BinaryTreeNode parent = null;
        Iterator<E> it = this.iterator();

        if (it.hasNext()) {
            if (it.next().equals(searchNode)) {
                parent = searchNode;
                return parent;
            }
        }
        ...
        while (it.hasNext()) {
            parent = (BinaryTreeNode) it.next();
            if (parent.leftChild.equals(searchNode) || parent.rightChild.equals(searchNode)) {
                return parent;
            }
        }
        return null;
    ...
    public BinaryTreeNode leftRotation(BinaryTreeNode pivot) {
        BinaryTreeNode parent, rightNode, rightNodeLeft;

        parent = this.search(pivot);
        if (parent == null) {

        } else if (parent.leftChild.equals(pivot)) {

        } else if (parent.rightChild.equals(pivot)) {
    ...
    public BinaryTreeNode rightRotation(BinaryTreeNode pivot) {
        BinaryTreeNode parent, leftNode, leftNodeRight;
    ...
    public BinaryTreeNode leftRotation() {
        BinaryTreeNode rightNode, rightNodeLeft, tempNode;
        rightNode = rootNode.rightChild;
        rightNodeLeft = rightNode.leftChild;
        tempNode = rootNode;
        tempNode.rightChild = null;
        rightNode.leftChild = null;

        tempNode.rightChild = rightNodeLeft;
        rightNode.leftChild = tempNode;
        rootNode = rightNode;
        return rootNode;
    }

    public BinaryTreeNode rightRotation() {
        BinaryTreeNode leftNode, leftNodeRight, tempNode;
        leftNode = rootNode.leftChild;
        leftNodeRight = leftNode.rightChild;
        tempNode = rootNode;
        tempNode.leftChild = null;
        leftNode.rightChild = null;

        tempNode.leftChild = leftNodeRight;
        leftNode.rightChild = tempNode;
        rootNode = leftNode;
        return rootNode;
    }
    ...
    public static void main(String[] args) {  // create the binary search tree
        BinarySearchTreeSearch<String> tree = new BinarySearchTreeSearch<>();
        // build the tree
        tree.add("cow");
        tree.add("fly");
        tree.add("dog");
        ...
        System.out.println("Root: " + tree.rootNode.element);
        tree.leftRotation();
        System.out.println("Root: " + tree.rootNode.element);
