...
public class GraphAlgorithms {
    ...
    public static <E> List<Vertex<E>> depthFirstSearch(GraphADT<E> graph, Vertex<E> startVertex) {
        ...
        while (!processingStack.isEmpty()) {
            ...
            Iterator<Vertex<E>> iterator = topVertex.adjacentVertices().iterator();
            boolean found = false;
    ...
    public static <E> Set<Vertex<E>> recursiveDFSS(GraphADT<E> graph, Vertex<E> startVertex) {
        if (!graph.containsVertex(startVertex)) {
            throw new IllegalArgumentException();
        }
        ...
        return recursiveDepthFirstSearch(visitedVertices, startVertex);
    }

    private static <E> Set<Vertex<E>> recursiveDepthFirstSearch(Set<Vertex<E>> visitedVertices, Vertex<E> currentVertex) {

        visitedVertices.add(currentVertex);

        for (Vertex ver : currentVertex.adjacentVertices()) {
            if (!visitedVertices.contains(ver)) {
                recursiveDepthFirstSearch(visitedVertices, ver);
            }
        }
        return visitedVertices;
    }
    ...
    public static void main(String[] args) {
        ...
        Set<Vertex<String>> list2 = recursiveDFSS(graph, auckland);
